...
function create_button(){
    ...
    button2.id="but2";
    button2.addEventListener("click",table_data(10,19));
    button2.innerHTML="2";

    var button3=document.createElement("button");
    button3.setAttribute("type","button");
    button3.id="but3";
    button3.addEventListener("click",table_data(20,29));
    button3.innerHTML="3";

    var button4=document.createElement("button");
    button4.setAttribute("type","button");
    button4.id="but4";
    button4.addEventListener("click",table_data(30,39));
    button4.innerHTML="4";

    var button5=document.createElement("button");
    button5.setAttribute("type","button");
    button5.id="but5";
    button5.addEventListener("click",table_data(40,49));
    button5.innerHTML="5";

    var button6=document.createElement("button");
    button6.setAttribute("type","button");
    button6.id="but6";
    button6.addEventListener("click",table_data(50,59));
    button6.innerHTML="6";

    var button7=document.createElement("button");
    button7.setAttribute("type","button");
    button7.id="but7";
    button7.addEventListener("click",table_data(60,69));
    button7.innerHTML="7";

    var button8=document.createElement("button");
    button8.setAttribute("type","button");
    button8.id="but8";
    button8.addEventListener("click",table_data(70,79));
    button8.innerHTML="8";

    var button9=document.createElement("button");
    button9.setAttribute("type","button");
    button9.id="but9";
    button9.addEventListener("click",table_data(80,89));
    button9.innerHTML="9";

    var button10=document.createElement("button");
    button10.setAttribute("type","button");
    button10.id="but10";
    button10.addEventListener("click",table_data(90,99));
